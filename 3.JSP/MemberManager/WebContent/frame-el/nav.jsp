...
<div id="nav">
	<ul>
		...
		<li><a href="<c:url value="/member-el/login.jsp" />">로그인</a></li>
		<li><a href="<c:url value="/member-el/memberRegForm.jsp" />">회원가입</a></li>
		<li><a href="<c:url value="/member-el/myPage.jsp" />">MY PAGE</a></li>
		<li><a href="<c:url value="/member-el/myPage2.jsp" />">MY PAGE2</a></li>
		<li><a href="<c:url value="/member-el/memberList2.jsp" />">회원리스트</a></li>
		<li><a href="<c:url value="/member-el/memberList2.jsp" />">회원리스트2</a></li>
